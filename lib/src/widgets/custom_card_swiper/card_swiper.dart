...
import 'package:dating_app/src/widgets/custom_card_swiper/allowed_swipe_direction.dart';
import 'package:dating_app/src/widgets/custom_card_swiper/card_animation.dart';
import 'package:dating_app/src/widgets/custom_card_swiper/card_swiper_controller.dart';
import 'package:dating_app/src/widgets/custom_card_swiper/enums.dart';
import 'package:dating_app/src/widgets/custom_card_swiper/extensions.dart';
...
class _CardSwiperState<T extends Widget> extends State<CardSwiper>
  ...
  Widget _backItem(BoxConstraints constraints, int index) {
    return Positioned(
        ...
        //               child: widget.cardBuilder(
        //                       context, getValidIndexOffset(index)!, 0, 0) ??
        //                   const SizedBox()),
        //         ),
        //       ),
        //     ),
